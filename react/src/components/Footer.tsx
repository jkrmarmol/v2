    ...
    <div className="footer">
      ...
      <div className="social-media">
        <div className="medium">
          <a href="https://xkurtph.medium.com" target='_blank'>
            <motion.svg
        ...
        <div className="facebook">
          <a href="https://www.facebook.com/jkrmarmol" target='_blank'>
            <motion.svg
              whileHover={{ scale: 1.3 }}
              xmlns="http://www.w3.org/2000/svg"
              width="24"
        ...
        <div className="linkedin">
          <a href="https://www.linkedin.com/in/jkrmarmol" target='_blank'>
            <motion.svg
              whileHover={{ scale: 1.3 }}
              xmlns="http://www.w3.org/2000/svg"
              width="24"
      ...
      <div className="name">
        <p>Designed & Developed by Kurt Russelle Marmol</p>
      </div>
    </div>
